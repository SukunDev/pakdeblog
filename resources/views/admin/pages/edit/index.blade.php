            ...
            <form class="space-y-4" action="/{{ Request::path() }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex flex-col">
                    ...
                    <input
                        ...
                        type="text" name="title" id="titleForm" value="{{ $page->title }}" required>
                </div>
                <div id="permalink" class="px-1 flex items-center">
                    <p class="font-medium line-clamp-1">Permalink: <span
                            class="text-blue-500 hover:underline font-normal cursor-pointer">{{ App\Helpers\AppHelper::instance()->getOptions('site_url') }}/p/{{ $page->slug }}</span>
                    </p>
                    <div id="edit-permalink" class="flex items-end" style="display: none">
                        <input
                            ...
                            type="text" name="slug" id="slugForm" value="{{ $page->slug }}" required>
