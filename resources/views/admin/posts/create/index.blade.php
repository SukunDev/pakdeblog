            ...
            <form class="space-y-4" action="/{{ Request::path() }}" method="POST" enctype="multipart/form-data">
                ...
                <div id="permalink" class="px-1 flex items-center" style="display: none">
                    <p class="font-medium line-clamp-1">Permalink: <span
                            class="text-blue-500 hover:underline font-normal cursor-pointer">{{ App\Helpers\AppHelper::instance()->getOptions('site_url') }}/</span>
                    </p>
                ...
                <div class="flex flex-col">
                    ...
                    <select
                        class="px-4 py-2 rounded-md bg-gray-200 focus:outline-gray-200 focus:bg-white focus:shadow-md transition duration-300"
                        name="category_id" id="categoryForm" required>
                ...
                <div class="flex flex-col">
                    ...
                    <textarea id="metaDiscriptionForm" rows="3"
                        ...
                        placeholder="jumlah karakter max 160" name="meta_description" required>{{ old('meta_description') }}</textarea>
                ...
                <div class="flex flex-col">
                    ...
                    <input
                        class="px-4 py-2 rounded-md bg-gray-200 focus:outline-gray-200 focus:bg-white focus:shadow-md transition duration-300"
                        type="text" name="meta_keyword" id="metaKeywordForm" value="{{ old('meta_keyword') }}"
                        required>
                </div>
